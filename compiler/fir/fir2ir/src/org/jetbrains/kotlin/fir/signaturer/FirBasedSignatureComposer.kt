...
class FirBasedSignatureComposer(override val mangler: FirMangler) : Fir2IrSignatureComposer {
    ...
    private val signatureCache = mutableMapOf<Pair<FirDeclaration, ClassId?>, IdSignature.CommonSignature>()
    ...
    override fun composeSignature(
        ...
        val publicSignature = signatureCache.getOrPut(declaration to containingClassId) {
            calculatePublicSignature(declaration, containingClassId)
        }
    ...
    private fun calculatePublicSignature(
        declaration: FirDeclaration,
